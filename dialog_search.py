...
class SearchDialog(object):
    ...
    def setupUi(self, dlgSearch):
        ...
        self.tblShotList.header().setSectionResizeMode(QtWidgets.QHeaderView.ResizeToContents)
        self.tblSelectedShots.header().setSectionResizeMode(QtWidgets.QHeaderView.ResizeToContents)
